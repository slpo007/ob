...
(function ($) {
    ...
    function Slide(ele, options) {
        ...
        // 有几张图片就配置几个对象
        this.states = [
            { '&zIndex': 1, width: 100, height: 100, top: 100, left: 520, $opacity:1,padding:0},
            { '&zIndex': 2, width: 180, height: 260, top: 90, left: 0, $opacity: 1,padding:20 },
            { '&zIndex': 3, width: 190, height: 280, top: 72, left: 225, $opacity: 1,padding:20 },
            { '&zIndex': 4, width: 210, height: 340, top:-20, left: 456, $opacity: 1,padding:30 },
            { '&zIndex': 3, width: 190, height: 280, top: 72, left: 730, $opacity: 1,padding:20,},
            { '&zIndex': 2, width: 180, height: 260, top: 90, left: 975, $opacity: 1,padding:20 },
            { '&zIndex': 1, width: 100, height: 100, top: 100, left: 520, $opacity: 0,padding:0 }
        ]
    ...
    Slide.prototype = {
        ...
        play: function () {
            ...
            this.interval = setInterval(function () {//这个this指window
                ...
                // self.states.unshift(self.states.pop())       //从后往前走
                // self.states.push(self.states.shift())     //从前往后走
                this.next()
